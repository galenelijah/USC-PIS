...
CSP_IMG_SRC = ("'self'", "data:", "blob:", "https:", "https://res.cloudinary.com")
CSP_CONNECT_SRC = ("'self'", "blob:", "data:", "https://res.cloudinary.com")
CSP_FRAME_SRC = ("'self'", "blob:", "data:", "https://res.cloudinary.com")
CSP_FRAME_ANCESTORS = ("'none'",)
CSP_OBJECT_SRC = ("'self'", "blob:", "data:", "https://res.cloudinary.com")
CSP_BASE_URI = ("'self'",)
...
CSRF_USE_SESSIONS = False # Standard cookie-based CSRF is easier for SPAs
