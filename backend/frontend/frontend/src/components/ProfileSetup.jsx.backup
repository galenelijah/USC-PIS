...
const ProfileSetup = () => {
  ...
  const renderStepContent = (step) => {
    ...
    switch (step) {
      case 0:
        return (
          <Fade in timeout={500} key="step-0-content">
            <Card elevation={0} sx={{ border: '1px solid', borderColor: alpha('#667eea', 0.2), borderRadius: 3 }}>
              <CardContent sx={{ p: 4 }}>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6} key="first_name_grid">
                    <MyTextField
                      key="step-0-first_name"
                      label="First Name"
                      name="first_name"
                      control={control}
                      required
                  ...
                  <Grid item xs={12} sm={6} key="last_name_grid">
                    <MyTextField
                      label="Last Name"
                      name="last_name"
                      control={control}
      ...
      case 1:
        return (
          <Fade in timeout={500} key="step-1-content">
      ...
      case 2:
        return (
          <Fade in timeout={500} key="step-2-content">
      ...
      case 3:
        return (
          <Fade in timeout={500} key="step-3-content">
            <Stack spacing={3}>
              {/* Emergency Contacts */}
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <Box sx={{ p: 4, pt: 2 }}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} key={`form-step-${activeStep}`}>
