...
### 2. Infrastructure & Stability Fixes
...
- **Test Integrity:** Rewrote and verified `tests_performance_v2` and `tests_integration_v2` to utilize the new schema (`created_by`, `issuance_status`), achieving a 100% pass rate locally.
